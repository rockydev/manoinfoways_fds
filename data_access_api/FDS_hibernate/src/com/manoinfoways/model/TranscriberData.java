...
public class TranscriberData implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 5060775702426750536L;
	...
	public TranscriberData(String transcriberId) {
		this.transcriberId = transcriberId;
	}

	public TranscriberData(String transcriberId,
			TranscriberTypeData transcriberTypeData, String password,
			String transcriberName, Date dateofJoining,
			String transcriberAddress, String transcriberPermanentAddress,
			Integer transcriberPhnNuber, Integer transcriberMobile,
			String transcriberEmail, String transcriberQualification,
			String transcriberExperience, Date transcriberDob,
			Date transcriberLoginTime, Set<VoiceFilesData> voiceFilesDatas) {
		this.transcriberId = transcriberId;
