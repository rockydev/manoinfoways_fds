...
public class FileListData {
	public static void main(String[] args)
		...
		File folder = new File("C:\\Users\\rdevinen\\Desktop\\MD");
...
//						/ format.getFrameRate();
				...
				System.out.println(doctorDataBean
								.getDoctorIdByAbbr(docId));
				System.out.println(clinicDataBean
								.getClinicIdByAbbr(clinicName));
				InboundVoiceFilesData vfData = new InboundVoiceFilesData(
						 doctorDataBean.findById(doctorDataBean
								.getDoctorIdByAbbr(docId)), clinicDataBean.findById(clinicDataBean
								.getClinicIdByAbbr(clinicName)), filePath, date, list.get(i).length());
