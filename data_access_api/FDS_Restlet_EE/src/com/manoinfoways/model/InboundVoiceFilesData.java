...
public class InboundVoiceFilesData implements java.io.Serializable {
	...
	private double lengthOfDictation;
	...
	public InboundVoiceFilesData(Integer fileId) {
		this.fileId = fileId;
	}
	...
	public InboundVoiceFilesData(DoctorData doctorData, ClinicData clinicData,
			String filePath, Date inboundDate, double lengthOfDictation,
	...
	public double getLengthOfDictation() {
		return this.lengthOfDictation;
	}

	public void setLengthOfDictation(double lengthOfDictation) {
		this.lengthOfDictation = lengthOfDictation;
	}
